...
# --------------------------------------------------------------------------
# 1) 장학금 데이터 (+ url 필드)
#    👉 각 'url'에 실제 "상세/신청" 페이지 주소를 채워 넣으세요!
# --------------------------------------------------------------------------
def create_scholarship_df():
    data = [
        ...
        {'장학금명': 'AI서울테크 대학원 장학금', '구분': '대학원생', '학년 정보': '대학원 재학생',
         ...
         'url': 'https://www.hissf.or.kr/home/kor/M075356964/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffe0da50bb4e2a1672fcc14ff2318200bfa&idx3=cb00d1a0008a85e71a41b8741facbffe0da50bb4e2a1672fcc14ff2318200bfa&act=&tabPos3=C#'},  # TODO: 실제 상세/신청 URL로 교체
        ...
        {'장학금명': '서울희망 대학진로 장학금', '구분': '대학생',
         ...
         'url': 'https://www.hissf.or.kr/home/kor/M338346211/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffe4d70c2b189c2c79f9576c3797a0949b1&idx3=cb00d1a0008a85e71a41b8741facbffe4d70c2b189c2c79f9576c3797a0949b1&act=&tabPos3=A'},  # TODO

        {'장학금명': '서울희망 공익인재 장학금', '구분': '대학생',
         '학년 정보': '재학생(2학년 이상)', '전공 계열': '전공무관',
         '필수 조건': '사회공헌활동 경험자', '경제상황 요건': '해당 없음',
         'url': 'https://www.hissf.or.kr/home/kor/M338346211/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffe2a91d3ee98d60342f28473f4a1fdb3e4&idx3=cb00d1a0008a85e71a41b8741facbffe2a91d3ee98d60342f28473f4a1fdb3e4&act=&tabPos3=A'},  # TODO

        {'장학금명': '독립유공자 후손 장학금', '구분': '대학생',
         '학년 정보': '신입생(1학년), 재학생(2학년 이상)', '전공 계열': '전공무관',
         '필수 조건': '독립유공자 후손 (4~6대)', '경제상황 요건': '해당 없음',
         'url': 'https://www.hissf.or.kr/home/kor/M338346211/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffe3fc96574ebd8c66af64789274f5f686f&idx3=cb00d1a0008a85e71a41b8741facbffe3fc96574ebd8c66af64789274f5f686f&act=&tabPos3=A'},  # TODO

        {'장학금명': '서울 해외교환학생 장학금', '구분': '대학생',
         '학년 정보': '재학생(2학년 이상)', '전공 계열': '전공무관',
         '필수 조건': '해외교환학생으로 선발된 자',
         '경제상황 요건': '기초생활수급자/법정차상위계층, 학자금지원 4구간 이내',
         'url': 'https://www.hissf.or.kr/home/kor/M338346211/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffe76bede247ad7fca503608770da735e0b&idx3=cb00d1a0008a85e71a41b8741facbffe76bede247ad7fca503608770da735e0b&act=&tabPos3=A'},  # TODO

        {'장학금명': '청춘Start 장학금', '구분': '대학생',
         '학년 정보': '신입생(1학년)', '전공 계열': '전공무관', '필수 조건': '해당 없음',
         '경제상황 요건': '기초생활수급자/법정차상위계층, 아동복지시설 퇴소자',
         'url': 'https://www.hissf.or.kr/home/kor/M338346211/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffe71a547009cdc82b6a17d02db013fb623&idx3=cb00d1a0008a85e71a41b8741facbffe71a547009cdc82b6a17d02db013fb623&act=&tabPos3=A'},  # TODO

        {'장학금명': '서울희망 직업전문학교 장학금', '구분': '대학생',
         '학년 정보': '직업전문학교 학생', '전공 계열': '전공무관', '필수 조건': '해당 없음',
         '경제상황 요건': '기초생활수급자/법정차상위계층',
         'url': 'https://www.hissf.or.kr/home/kor/M338346211/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffe33a0bf6dc445c148169c7d619bdff9fc&idx3=cb00d1a0008a85e71a41b8741facbffe33a0bf6dc445c148169c7d619bdff9fc&act=&tabPos3=A'},  # TODO

        # 고등학생
        {'장학금명': '서울희망고교진로 장학금', '구분': '고등학생',
         '학년 정보': '고등학교 재학생', '전공 계열': '전공무관', '필수 조건': '해당 없음',
         '경제상황 요건': '기초생활수급자, 차상위계층, 북한이탈주민, 경제사각지대',
         'url': 'https://www.hissf.or.kr/home/kor/M125164715/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffe04b930aaf4ff976a1b2120a7ae0856f3&idx3=cb00d1a0008a85e71a41b8741facbffe04b930aaf4ff976a1b2120a7ae0856f3&act=&tabPos3=B'},  # TODO

        {'장학금명': '서울희망 예체능 장학금', '구분': '고등학생',
         '학년 정보': '고등학교 재학생', '전공 계열': '예체능', '필수 조건': '예체능 특기자',
         '경제상황 요건': '기초생활수급자/법정차상위계층, 학교장 추천 받은 학생',
         'url': 'https://www.hissf.or.kr/home/kor/M125164715/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffe5af0e69807254d86d6a4697a439067f4&idx3=cb00d1a0008a85e71a41b8741facbffe5af0e69807254d86d6a4697a439067f4&act=&tabPos3=B'},  # TODO

        {'장학금명': '서울꿈길장학금', '구분': '고등학생',
         '학년 정보': '비인가 대안교육기관 재학 청소년', '전공 계열': '전공무관', '필수 조건': '학교장 추천',
         '경제상황 요건': '기초생활수급자/법정차상위계층, 학교장 추천',
         'url': 'https://www.hissf.or.kr/home/kor/M125164715/scholarship/info/view.do?idx=cb00d1a0008a85e71a41b8741facbffeb867cf7f5c7adc365326c976b22336f5&idx3=cb00d1a0008a85e71a41b8741facbffeb867cf7f5c7adc365326c976b22336f5&act=&tabPos3=B'}   # TODO
    ]
...
def display_results(result_df):
    ...
    for _, row in result_df.iterrows():
        # 버튼 HTML: url 유효 시 링크, 아니면 비활성 문구
        detail_url = row.get("url", "")
        if isinstance(detail_url, str) and detail_url.startswith(("http://", "https://")):
            btn_html = f'<a class="btn-yellow" href="{detail_url}" target="_blank">해당 장학금 ‘신청 페이지’로 이동 ↗</a>'
        else:
            btn_html = '<span class="btn-yellow" style="opacity:.6;">신청 페이지 URL 준비 중 🙏</span>'
